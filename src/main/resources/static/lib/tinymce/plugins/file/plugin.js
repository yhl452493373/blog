...
var file = (function () {
    ...
    var getPrependUrl = function (editor) {
      return editor.getParam('file_prepend_url', '');
    };
    var getClassList = function (editor) {
      return editor.getParam('file_class_list');
    };
    ...
    var getImageList = function (editor) {
      return editor.getParam('file_list', false);
    };
    var hasUploadUrl = function (editor) {
      return editor.getParam('files_upload_url', false);
    };
    var hasUploadHandler = function (editor) {
      return editor.getParam('files_upload_handler', false);
    };
    var getUploadUrl = function (editor) {
      return editor.getParam('files_upload_url');
    };
    var getUploadHandler = function (editor) {
      return editor.getParam('files_upload_handler');
    };
    var getUploadBasePath = function (editor) {
      return editor.getParam('files_upload_base_path');
    };
    var getUploadCredentials = function (editor) {
      return editor.getParam('files_upload_credentials');
    };
    var Settings = {
    ...
    var wrapInFigure = function (image) {
      var figureElm = DOM.create('figure', { class: 'file' });
    ...
    var create = function (normalizeCss, data) {
      ...
      if (data.caption) {
        var figure = DOM.create('figure', { class: 'file' });
    ...
    var getSelectedImage = function (editor) {
      ...
      var figureElm = editor.dom.getParent(imgElm, 'figure.file');
      if (figureElm) {
    ...
    var deleteImage = function (editor, image) {
      if (image) {
        var elm = editor.dom.is(image.parentNode, 'figure.file') ? image.parentNode : image;
    ...
    var onSrcChange = function (evt, editor) {
      ...
      var imageListCtrl = rootControl.find('#file-list')[0];
      if (imageListCtrl) {
    ...
    var register = function (editor) {
      editor.addCommand('mceFile', Dialog(editor).open);
    };
    var Commands = { register: register };

    var hasImageClass = function (node) {
      var className = node.attr('class');
      return className && /\bfile\b/.test(className);
    };
    ...
    var register$1 = function (editor) {
      editor.addButton('file', {
        ...
        stateSelector: 'a:not([data-mce-object],[data-mce-placeholder]),figure.file'
      });
      editor.addMenuItem('file', {
        icon: 'image',
        text: 'File',
        onclick: Dialog(editor).open,
        context: 'insert',
    ...
    global.add('file', function (editor) {
