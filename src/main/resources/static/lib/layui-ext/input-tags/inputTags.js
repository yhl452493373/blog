...
layui.define(['jquery', 'layer'], function (exports) {
    ...
    Class.prototype.enter = function () {
        ...
        options.elem.keypress(function (event) {
            ...
            if (keynum === 13) {
                ...
                options.done && typeof options.done === 'function' && options.done.call(that, $val);
                options.elem.val('');
            }
        })
    };
    ...
    Class.prototype.events = function () {
        ...
        $('.inputTags').on('click', '.close', function () {
            ...
            options.del && typeof options.del === 'function' && options.del.call(that, ThisText);
        })
    };
