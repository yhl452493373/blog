                    ...
                    success: function (n, l) {
                        layui.use("upload", function (o) {
                            ...
                            o.render({
                                ...
                                var a = "";
                                "" != n.find('input[name="imgWidth"]').val() && (a += "width:" + n.find('input[name="imgWidth"]').val() + "px;"), "" != n.find('input[name="imgHeight"]').val() && (a += "height:" + n.find('input[name="imgHeight"]').val() + "px;"), h.call(t, "img", {
                                    src: c.val(),
                                    alt: r.val(),
                                    style: a
                                }, e), i.close(l)
